        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-semibold">Agregar un Proveedor</h2>
                    <a href="{{ route('proveedores.index') }}" class="btn btn-primary btn-sm">&larr; Atrás</a>
                </div>

                <form id="proveedoresForm" action="{{ route('proveedores.store') }}" method="post">
                    @csrf
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-input mt-1 block w-full rounded-md border-gray-300 @error('nombre_contacto') border-red-500 @enderror" id="nombre_contacto" name="nombre_contacto" value="{{ old('nombre_contacto') }}">
                    ...
                    <div class="mb-4">
                        <button type="submit" id="submitButton" class="py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Agregar Proveedor</button>
                    </div>
                </form>
            </div>
        </div>
