    ...
    <div class="md:w-3/4 mx-auto">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <form id="categoryForm" action="{{ route('products.store') }}" method="post">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" class="form-input mt-1 block w-full rounded-md border-gray-300 @error('existencia') border-red-500 @enderror" id="existencia" name="existencia" value="{{ old('existencia') }}">
                        @error('existencia')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
