            ...
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <form action="{{ route('categories.update', $category->id) }}" method="post">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-input mt-1 block w-full rounded-md border-gray-300 @error('code') border-red-500 @enderror" id="code" name="code" value="{{ $category->code }}">
                        @error('code')
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-textarea mt-1 block w-full rounded-md border-gray-300 @error('description') border-red-500 @enderror" id="description" name="description">{{ $category->description }}</textarea>
                        @error('description')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
